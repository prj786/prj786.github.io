...
<div class="wrap page">
	...
	<section id="shell">
		...
		<h2>Written once, in QML.</h2>
		<p>
			Hyprland is the Wayland compositor, configured in Lua. Everything you actually touch is a
			first-party Quickshell shell — one codebase, one design language, no widget zoo.
		</p>
		<div class="grid">
			<div class="card">
				<h3>Bar</h3>
